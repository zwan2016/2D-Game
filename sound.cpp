  ...
  channels() 
{
  ...
  sounds.push_back( Mix_LoadWAV("sound/bug.wav") );//0
  sounds.push_back( Mix_LoadWAV("sound/ufodead.wav") );//1
  sounds.push_back( Mix_LoadWAV("sound/damage.wav") );//2
  sounds.push_back( Mix_LoadWAV("sound/shoot.wav") );//3
  sounds.push_back( Mix_LoadWAV("sound/jump.wav") );//4
  sounds.push_back( Mix_LoadWAV("sound/dead.wav") );//5
  sounds.push_back( Mix_LoadWAV("sound/revive.wav") );//6
